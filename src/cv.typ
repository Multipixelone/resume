...
#let _cvHeader(
  ...
  let makeHeaderInfo() = {
    let personalInfoIcons = (
      ...
      linkedin: fa-linkedin(style: "brands"),
      homepage: fa-house-laptop(style: "solid"),
      github: fa-square-github(style: "brands"),
      gitlab: fa-gitlab(style: "brands"),
      orcid: fa-orcid(style: "brands"),
      researchgate: fa-researchgate(style: "brands"),
